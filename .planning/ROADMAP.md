...
**Plans**: 3 plans
  ...
  - [x] 12-02-service-and-openapi-PLAN.md — Migrate HTTP integration tests; add OpenAPI contract test + Tier-1 full-key-set contract test; full pytest suite gate
...
| 12. Wire Contract | v1.2 | 2/3 | In Progress|  |
