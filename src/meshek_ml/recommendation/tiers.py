...
def tier_3_ml_forecast(
    ...
    row identical in shape to the training-time feature matrix. Converts
    the forecasted mean demand to an order quantity via the newsvendor
    model (Normal approximation, residual std as sigma).
